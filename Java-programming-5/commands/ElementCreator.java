...
import test.lab.common.Read.PARR.Limit.Maximum;
import test.lab.common.Read.PARR.Limit.Minimum;
...
public final class ElementCreator {
    ...
    public static Product creatProduct() {
        ...
        float x = ReFloatReader.read("Введите Х: ", new Maximum(C814));
        long y = RelongReader.read("Введите Y: ", new Maximum(C85));
        double price = RefDoubleReader.read("Введите цену: ", new Minimum(0));
        ...
        Integer id = IDGenerator.gernerateID();
